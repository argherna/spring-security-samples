...
import com.github.argherna.spring.security.sample.saml.webview.SecureInfoController;

@Ignore
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(loader = SpringBootContextLoader.class, classes = {TestConfig.class})
@WebAppConfiguration
public class SecureInfoControllerTest extends CommonTestSupport {

  @InjectMocks
  private SecureInfoController landingController;
